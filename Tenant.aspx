<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage2.master" AutoEventWireup="true" CodeFile="Tenant.aspx.cs" Inherits="admin_Tenant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pagelink" runat="Server">
   ...
   <%-- testing end--%>
    <ol class="breadcrumb page-breadcrumb pull-right">
        ...
        <li class="hidden"><a href="#">Add/Update Tenant</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li class="active">Add/Update Tenant</li>
    </ol>
    <div class="clearfix">
    </div>
</asp:Content>
